...
/**
 * It will create the HTML structure of a Card with the information of a Pokemon.
 * Take into account if the pokemon is part of the user's Favs or Team.
 * @param {Object} pokemon Contains the pokemon information
 */
const createPokemonCard = (pokemon) => {
  let wrapper = document.createElement("div");
  // Default Image Values
  const cardImg = pokemon.img || "img/Poke_Ball.png";
...
/**
 * Displays a list of Card in specified item.
 * Replace the current content with that of the list.
...
/**
 * Get a list of pokemons to display
...
/**
 * Given the data of a pokemon it maps it to a simpler pokemon object
 * @param {objet} data Data from pokemon in API format
 */
...
/**
 * Show a list of cards in the discover section
 * get the elements to show from data.discover
 */
...
/**
 * Show the following pokemons page
 */
...
/**
 * Show previous page of pokemons
 */
...
/**
 * Configure what is necessary to make it work
 */
const App = () => {
